...
def create_policy(args: Args) -> _policy.Policy:
    ...
    if args.min_denoise_steps == args.max_denoise_steps:
        denoise_steps_range = None
        sample_kwargs = {"num_steps": args.min_denoise_steps}
    else:
        denoise_steps_range = (args.min_denoise_steps, args.max_denoise_steps)
        sample_kwargs = None
    match args.policy:
        case Checkpoint():
            return _policy_config.create_trained_policy(
